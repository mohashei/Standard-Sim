...
"""
def test(rank, config_file, world_size):
    ...
    configuration['test_dataset_params']['is_multigpu'] = is_multigpu
    test_dataset = create_dataset(configuration['test_dataset_params'])
    test_dataset_size = len(test_dataset)
    print('The number of test samples = {0}'.format(test_dataset_size))

    print('Initializing model...')
    test_epochs = configuration['model_params']['val_epochs']
...
if __name__ == '__main__':
    ...
    run_test(test, args.configfile, n_gpus)
