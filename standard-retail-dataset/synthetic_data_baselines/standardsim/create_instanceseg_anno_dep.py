...
if __name__ == "__main__":
    ...
    for file in files:
        ...
        final_mask = np.zeros((segmentation_image.shape[0], segmentation_image.shape[1]))
    ...
    with open("/app/synthetic_data_baselines/utils/synthetic_instance_anno.json", 'w') as jsonFile:
